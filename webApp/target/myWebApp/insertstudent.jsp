...
<form id="form" class="col-3 m-lg-3" method="POST" action="/webApp_war_exploded/">
    ...
    <div>
        ...
        <input class="form-control" id="salary" type="text" name="salary" value=""/>
    </div>
    <div>
        <label class="form-label" for="university_id">
            university_id
        </label>
        <input class="form-control" id="university_id" type="text" name="university_id" value=""/>
    </div>
    <input type="hidden" name="action" value="insert"/>
    <input type="hidden" name="id" value="1"/>
    <input type="hidden" name="jspname" value="insertstudent"/>
    <button type="submit" class="btn btn-primary" style="margin-top: 5px"> INSERT</button>
</form>
<br/>
<br/>
<br/>
