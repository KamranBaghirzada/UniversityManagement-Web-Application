...
<form id="form" class="col-3 m-lg-3" method="POST" action="/webApp_war_exploded/">
    <div class="mb-3">
        ...
        <input class="form-control" id="name" type="text" name="name" value="<%=student.getName()%>"/>
    </div>
    ...
    <div>
        ...
        <input class="form-control" id="surname" type="text" name="surname" value="<%=student.getSurname()%>"/>
    </div>
    <div>
        <label class="form-label" for="salary">
            salary
        </label>
        <input class="form-control" id="salary" type="text" name="salary" value="<%=student.getSalary()%>"/>
    </div>
    <input type="hidden" name="action" value="update"/>
    <input type="hidden" name="id" value="<%=id%>"/>
    <input type="hidden" name="jspname" value="updatestudent"/>
